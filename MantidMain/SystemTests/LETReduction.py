...
#---------------------------------------------------------------------------#
      # multiple energies provided in the data file
       prop['incident_energy'] = 'AUTO' #[17.4,5.5,2.67]
       ...
       prop['sample_run'] = [24374,24375] # 'LET18547.n001'
...
#------------------------------------------------------------------------------------#
   ...
   def def_advanced_properties(self):
      ...
      prop['background_range'] = [90000,99000] # TOF range for the calculating flat background
...
#### Set up time interval (sec) for reducer to check for input data file.         ####
    ...
    rd.wait_for_file = 300  # waiting time interval in seconds
