function [v_distr,vel_steps] =  InvertPulse3aI(f_samp,t_samp,v_samp,t_det,f_det_vs_t,L_det,V_pulse,tau_char,V_char,conv_pl_h,varargin)
% Fourier transformation using heterogeneous velocity scale. 
